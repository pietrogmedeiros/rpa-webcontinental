...
from rpa.pipedrive import run as pipedrive_run
from rpa.gdrive import upload as gdrive_upload
...
# Horário de execução — padrão: 07:00 (fuso America/Sao_Paulo)
...
if __name__ == "__main__":
    ...
    # Executa uma vez imediatamente ao subir (útil para testar)
